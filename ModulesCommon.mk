...
$(VSPMIF_KM):
	...
	$(ANDROID_MAKE) -C $(VSPMIF_KM_OUT_ABS)/vspm_if-module/files/vspm_if/drv/ $(KERNEL_COMPILE_FLAGS) CP=cp KERNELSRC=$(TARGET_KERNEL_SOURCE) KERNELDIR=$(KERNEL_OUT_ABS) PWD=$(VSPMIF_KM_OUT_ABS)/vspm_if-module/files/vspm_if/drv/
...
$(ETHAVB_MSE_KM):
	...
	$(ANDROID_MAKE) -C $(KERNEL_OUT_ABS) $(KERNEL_COMPILE_FLAGS) KERNELSRC=$(TARGET_KERNEL_SOURCE) KERNELDIR=$(KERNEL_OUT_ABS) INCSHARED="$(ETHAVB_MSE_KM_INCLUDES)" M=$(ETHAVB_MSE_KM_OUT_ABS)
